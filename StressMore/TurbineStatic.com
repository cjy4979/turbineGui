...
options = {
    ...
    'mp_head_node':('desktop-mc4hume', '192.168.43.197'),
    'mp_host_list':(('desktop-mc4hume', 8),),
    'mp_mode':MPI,
    'mp_mode_requested':MPI,
    'mp_mpi_validate':OFF,
    'mp_mpirun_path':'C:\\Program Files\\Microsoft MPI\\bin\\mpiexec.exe',
    'mp_rsh_command':'dummy %H -l CJY -n %C',
    'multiphysics':OFF,
    'noDmpDirect':[],
    'noGUI':None,
    'noMultiHost':[],
    ...
    'thermal':OFF,
    'tmpdir':'C:\\Users\\CJY\\AppData\\Local\\Temp',
    'tracer':OFF,
